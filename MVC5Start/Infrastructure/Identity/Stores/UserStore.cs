...
namespace MVC5Start.Infrastructure.Identity.Stores
{
        ...
        IUserLockoutStore<User, int> 
    {
        ...
        {
            return (await this.Connection.ExecuteScalarAsync<User>(Sql.Users.FindById, new { Id = userId }));
        }
        ...
        public async Task<User> FindByNameAsync(string userName)
        {
            ...
            return (await this.Connection.ExecuteScalarAsync<User>(Sql.Users.FindByName, new { UserName = userName}));
        }
        ...
        public async Task<User> FindAsync(UserLoginInfo login)
        {
            ...
            return (await this.Connection.ExecuteScalarAsync<User>(Sql.Users.SelectByLogin, new { login.LoginProvider, login.ProviderKey }));
        }
        ...
        public async Task<bool> IsInRoleAsync(User user, string roleName)
        {
            ...
            var record = (await this.Connection.ExecuteScalarAsync<UserRole>(Sql.UserRoles.IsInRole, new {UserId = user.Id, RoleName = roleName}));
        ...
        public async Task<User> FindByEmailAsync(string email)
        {
            ...
            return (await this.Connection.ExecuteScalarAsync<User>(Sql.Users.FindByEmail, new { Email = email}));
        }
